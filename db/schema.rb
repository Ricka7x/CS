...
ActiveRecord::Schema.define(version: 20160411191834) do
  ...
  add_index "subscriptions", ["course_id", "user_id"], name: "index_subscriptions_on_course_id_and_user_id", unique: true
